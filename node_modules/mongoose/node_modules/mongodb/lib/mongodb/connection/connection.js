...
var Connection = exports.Connection = function(id, socketOptions) {
  ...
  // ksk  this.socketOptions = socketOptions ? socketOptions : {host:'localhost', port:27017, domainSocket:false};
  this.socketOptions = socketOptions ? socketOptions : {host:'mongo', port:27017, domainSocket:false};
